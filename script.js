...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const passages = {
    prepositions: [
      ...
      },
      {
        ...
        hints: [
          "Which preposition best shows the kite’s position in the sky?",
    ...
    conjunctions: [
      {
        ...
        hints: [
          ...
          "Which word shows the result of his choice?"
        ],
        hint: "Remember to use the objects around you as clues."
      },
      {
        ...
        hints: [
          ...
          "Which one indicates an alternative?",
          "Which gives the reason for liking strawberries?",
          "When is fruit eaten?",
          "Which shows a choice for a snack?"
        ],
        hint: "Remember to use the objects around you as clues."
      },
      {
        ...
        hints: [
          "Which conjunction contrasts the dog’s and cat’s sounds?",
          "What is the reason for their behavior?",
          "What connects the feeding event?",
          "How are the sleeping and playing actions related?",
          "Which word shows an unexpected contrast?"
        ],
        hint: "Remember to use the objects around you as clues."
      },
      {
      ...
      },
      {
        ...
        hints: [
          "Which conjunction shows the contrast between tiredness and play?",
          "What is the result of trying hard?",
          "When did the coach cheer?",
          "Which word contrasts happiness with exhaustion?",
          "What indicates the sequence before going home?"
        ],
        hint: "Remember to use the objects around you as clues."
      },
      {
        ...
        hints: [
          "Which conjunction links the dark sky with rain?",
      ...
      },
      {
        ...
        hints: [
          "Which word shows the result of a messy room?",
          "Why did you work fast?",
          "Who helped you?",
          "Which word contrasts tiredness with happiness?",
          "When did you rest?"
        ],
        hint: "Remember to use the objects around you as clues."
      },
    ...
    subjectVerbAgreement: [
      ...
      },
      {
        ...
        hints: [
          ...
          "Which form fits the singular 'motorcycle'?"
        ],
        hint: "Remember to use the objects around you as clues."
      },
      {
        ...
        hints: [
          ...
          "Which verb agrees with 'the dog'?"
        ],
        hint: "Remember to use the objects around you as clues."
      }
    ],
  ...
  // Voice Command Setup (kept as in original code)
  ...
  nextPassageButton.addEventListener("click", () => {
    ...
    if (allFilled) {
      ...
      // Award a badge after each passage
      badgesEarned++;
